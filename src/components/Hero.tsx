    ...
    <section id="home" className="relative bg-gradient-to-r from-bengali-red/10 to-bengali-orange/10 overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 py-12 md:py-16 relative z-10">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-base md:text-lg text-bengali-dark/80 my-6 max-w-2xl mx-auto">
          ...
          <div className="my-8 w-full max-w-5xl">
            <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl p-6 md:p-8 mb-6 border border-white/20">
              <h3 className="text-2xl md:text-3xl font-bold text-bengali-dark mb-6">
                <span className="text-bengali-red">Durga Puja 2025</span>
              </h3>
              <p className="text-base text-bengali-dark/80 mb-4 max-w-xl mx-auto">
              ...
              <div className="space-y-3 mb-4">
                <div className="flex items-center justify-center text-bengali-dark/70">
                  ...
                  <span className="text-base font-medium">October 3-5, 2025</span>
                </div>
                <div className="flex items-center justify-center text-bengali-dark/70">
                  <Clock className="w-4 h-4 mr-2 text-bengali-red" />
                  <span className="text-base font-medium">11:00 AM - 10:00 PM</span>
                </div>
                <div className="flex items-center justify-center text-bengali-dark/70">
                  <MapPin className="w-4 h-4 mr-2 text-bengali-red" />
                  <span className="text-base font-medium">Indian Cultural Center</span>
                  <a 
              ...
              <div className="text-center space-y-3">
                <p className="text-base md:text-lg text-bengali-dark/80 mb-4">
                  Introducing <span className="font-semibold text-bengali-red">Madhubanti Bagchi</span>
                </p>
                
                <a 
                  href="#" 
                  className="inline-block text-bengali-red hover:text-bengali-red/80 underline pointer-events-none opacity-60 cursor-not-allowed text-base"
                  aria-disabled="true"
                >
                  Details coming soon
                </a>
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link to="/events">
              <Button className="bg-white hover:bg-gray-50 text-bengali-red border border-bengali-red px-6 py-2 text-base rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 font-light">
                View All Events
              </Button>
            </Link>
          </div>
