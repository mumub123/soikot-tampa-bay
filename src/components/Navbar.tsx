        ...
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center">
            <div className="text-4xl font-bold tracking-wide">
              <span className="bg-gradient-to-r from-bengali-red via-bengali-orange to-bengali-yellow bg-clip-text text-transparent font-serif italic">
                সৈকত
              </span>
              <span className="text-bengali-dark font-light ml-2 text-lg">| Soikot</span>
            </div>
          </Link>
